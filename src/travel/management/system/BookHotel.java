...
public class BookHotel extends JFrame implements ActionListener{
    ...
    String username;
    JLabel lblusername , lblid  ,lblnumber, lblphone , lblprice , labelprice, labelusername, labelid,labelnumber, labelphone;
    ...
    this.username= username;
       ...
       add(chotel);
        ...
        JLabel lblpersons = new JLabel("Toatal Persons");
       ...
       add(tfpersons);
        ...
        JLabel lbldays = new JLabel("Toatal No of Days");
       ...
       add(tfdays);
        ...
        JLabel lblac = new JLabel("A/c Non-Ac");
    ...
    public void actionPerformed(ActionEvent ae)
    {
                  ...
                  else if(ae.getSource() == bookpackage)
        {
            try{
                ...
                JOptionPane.showMessageDialog(null, "Hotel Booked Succuessfully");
                setVisible(false); 
            }
            catch(Exception e)
            {
